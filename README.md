About hachoir-parser-feedstock
==============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/hachoir-parser-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=2994&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/hachoir-parser-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `hachoir-parser` can be installed with `conda`:
...
```
mamba install hachoir-parser
```

It is possible to list all of the versions of `hachoir-parser` available on your platform with `conda`:
...
```
mamba search hachoir-parser --channel conda-forge
```
...
mamba repoquery search hachoir-parser --channel conda-forge

# List packages depending on `hachoir-parser`:
mamba repoquery whoneeds hachoir-parser --channel conda-forge

# List dependencies of `hachoir-parser`:
mamba repoquery depends hachoir-parser --channel conda-forge
```
